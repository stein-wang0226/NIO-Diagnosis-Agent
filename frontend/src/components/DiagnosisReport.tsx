...
export default function DiagnosisReport({
  ...
  const stats = [
    { label: '评分结果', value: result.is_relevant ? '✓ 相关' : '✗ 不相关', color: result.is_relevant ? 'text-emerald-600' : 'text-amber-600' },
  ...
  return (
    <div className="h-full overflow-y-auto p-4 space-y-4">
      ...
      <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
        <div className="text-xs font-semibold text-indigo-600 mb-3 uppercase tracking-wider">执行摘要</div>
